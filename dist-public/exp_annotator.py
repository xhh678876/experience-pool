...
Implements a 5-dimension per-turn reward schema:
    5 dimensions × {-1, 0, +1}: outcome, intent, execution, orchestration, expression
    confidence ∈ [0, 1]
    reason: one sentence

Key design property: per-turn evaluation uses *delayed feedback*
...
# ---------------------------------------------------------------------------
# Reward prompt. Kept as a single literal so the scoring schema stays stable
# across backends.
# ---------------------------------------------------------------------------
