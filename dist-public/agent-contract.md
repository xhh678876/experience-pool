...
For reusable distilled skills:

```bash
~/.experience-pool/bin/exp search-skills --q "<task domain>" --top-k 3
~/.experience-pool/bin/exp install-skill --name <skill-name> --target ./vendor/skills/<skill-name>
```
