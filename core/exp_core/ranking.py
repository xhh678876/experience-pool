"""Mixed ranking — copy of the formula in gateway/app/ranking.py, identical.
Keeping a parallel implementation here so core has zero deps on the gateway."""
...
def score_candidates(
    ...
    *,
    ...
    for cand, sz, qz in zip(candidates, sim_z, q_z, strict=True):
        ...
        q_comp = w_q * qz
        out.append((cand, sim_comp + q_comp + ucb, sim_comp, q_comp, ucb))
