...
Each user can own one or more agents. A user signs up with their @sii.edu.cn
email and a self-chosen password; the server creates:
...
ALLOWED_EMAIL_DOMAIN = os.getenv("EXP_EMAIL_DOMAIN", "sii.edu.cn")
