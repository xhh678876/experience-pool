...
| **Repo** | https://github.com/xhh678876/experience-pool |
...
| **Reviewer** (team lead / data steward) | Audit pending uploads, redact further, approve / reject; spot-check sanitizer hits. | Next.js UI at `https://expool.internal/`; CLI `exp approve / reject` |
...
**Reviewer side**
- Next.js 15 UI: dashboard, list, 5-tab detail page (card / trajectory /
...
- **F4.4** Every action logs to `audit_log` with `actor=reviewer:<X-Reviewer-Name cookie>`.
...
| **v0.6** GitHub release | Public repo, STATUS + ROADMAP + PRD + LICENSE | ✅ done | https://github.com/xhh678876/experience-pool |
