...
Usage:
    ...
    python3 bridge_push.py \\
        ...
        [--task <type>] [--acl public|team:<X>|private] [--sensitivity low|medium|high]
...
def main() -> int:
    ...
    ap.add_argument("--base", required=True, help="experience-pool API base, e.g. http://10.244.66.195:8081")
    ...
    ap.add_argument("--acl", default="team:imported", help="ACL: private | team:<X> | public")
