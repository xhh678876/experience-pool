...
python3 upload.py push \\
    ...
    --task ml_debug --acl public --sensitivity low
...
def cmd_push(args: argparse.Namespace) -> int:
    ...
    if eid:
        ...
        print(f"\n查看：{args.base.replace(':8081', ':3002')}/experiences/{eid}")
    return 0
...
def main() -> int:
    ...
    p.add_argument("--base", default=os.environ.get("EXP_BASE_URL", "http://10.244.66.195:8081"),
    ...
    sp.add_argument("--acl", default="public", help="private | team:<X> | public")
